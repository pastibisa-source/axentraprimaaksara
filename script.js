...
if (
    portfolioLightbox &&
    portfolioLightbox.classList.contains("show")
) {
...
const portfolioLightboxImage =
    document.getElementById("portfolioLightboxImage");

const portfolioLightboxTitle =
    document.getElementById("portfolioLightboxTitle");

const portfolioLightboxClose =
    document.getElementById("portfolioLightboxClose");
...
function openPortfolioPreview(image, title) {
    ...
    if (portfolioLightboxTitle) {
        ...
        portfolioLightboxTitle.textContent =
            title;
...
if (portfolioLightboxClose) {
    ...
    portfolioLightboxClose.addEventListener(
        "click",
        closePortfolioPreview
    );
